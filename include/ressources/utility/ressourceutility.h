...
namespace RESSOURCES{
    ...
    struct Loader{
        ...
        virtual std::string exportRessource(const std::string& path, Data*& data,const std::string& type_variant) = 0;
    };
    ...
    struct MeshLoader : public Loader {
        ...
        std::string exportRessource(const std::string& path, Data*& data,const std::string& type_variant)  override;

        static void _objLoader(const std::string& path,  MeshData& data);
        static std::string _objExport(const std::string& path, MeshData& data);
    };
    ...
    struct TextureLoader : public Loader {
        ...
        static std::string _jspExport(const std::string& path, TextureData& data);
    };
    ...
    struct TexteLoader : public Loader {
        ...
        static std::string _jspExport(const std::string& path, ShaderData& data);
    };
    ...
    struct MaterialArchetypeLoader : public Loader {
        ...
        static std::string jsonExport(const std::string& path, MaterialArchetypeData& data);
    };
    ...
    struct SceneLoader : public Loader {
        ...
        static std::string sceneExport(const std::string& path, SceneData& data);
    };
    ...
    struct ComponentLoader : public Loader {
        ...
        static std::string componentExport(const std::string& path, ComponentData& data);
    };
    ...
    struct GameObjectLoader : public Loader {
        ...
        static std::string gameObjectExport(const std::string& path, GameObjectData& data);
    };
